...
class _HomeRouteState extends State<HomeRoute> {
    ...
    if (!userModel.isLogin) {
      ...
      return Center(
        child: ElevatedButton(
          child: Text(S.current.login ?? "Fallback Login"),
  ...
  void _retrieveData() async {
    var data = await Git(context as BuildContext).getRepos( // 强制转换为BuildContext，因为此时肯定是Widget树中的一部分
      queryParameters: {
        'page': page,
        'page_size': 20,
      },
